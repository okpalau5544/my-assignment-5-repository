...
async function generateOpenApi (): Promise<void> {
  try {
    ...
    // we're calling our shell script here - but we don't really care about its
    // return values
...
// promise, in case multiple file changes cause the openapi generation to trigger in sequence
